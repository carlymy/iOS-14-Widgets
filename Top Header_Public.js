...
const apiKey = "b2ff987c496017d4d8e2d4abf1875223"
...
const textFormat = {
  ...
  largeDate1:  { size: 12, color: "", font: "semibold" },
  largeDate2:  { size: 16, color: "", font: "light" },
  
  greeting:    { size: 26, color: "", font: "semibold" },
  eventLabel:  { size: 10, color: "", font: "regular" },
  eventTitle:  { size: 10, color: "", font: "regular" },
  eventTime:   { size: 10, color: "ffffffcc", font: "light" },
  noEvents:    { size: 10, color: "", font: "semibold" },
  
  largeTemp:   { size: 10, color: "", font: "light" },
  smallTemp:   { size: 14, color: "", font: "" },
  tinyTemp:    { size: 12, color: "", font: "" },
  
  customText:  { size: 14, color: "", font: "" },
  
  battery:     { size: 14, color: "", font: "light" },
...
// (2) Select collection
// (3) Copy & paste collection number (it's in the URL) into Line 240 below 
